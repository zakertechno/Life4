            ...
            function promptNewUser(callback) {
                const msg = `
                    <div style="text-align:center; margin-top:0;">
                         <style>
                            .custom-modal-footer, .modal-actions { display: none !important; }
                            /* HACK: Tighten spacing between default modal title (Crear Perfil) and our content */
                            .custom-modal-box h3 { margin-bottom: 2px !important; padding-bottom: 0 !important; }
                            .custom-modal-box .modal-body { padding-top: 2px !important; }
                        </style>
                        <h3 style="color:#38bdf8; margin:0 0 5px 0; font-size:1.3rem;">¡Bienvenido a tu nueva vida!</h3>
                    </div>
                    <div class="intro-banner">
                        <p style="color:#e2e8f0; font-size:0.95rem; line-height:1.6; margin:0; position:relative; z-index:1;">
                    ...
                    <div style="margin:5px 0 15px 0;">
                        <label style="display:block; color:#94a3b8; font-size:0.85rem; margin-bottom:3px;">Tu Nombre</label>
                        <input type="text" id="start-player-name" placeholder="¿Cómo te llamas?" style="width:100%; padding:10px; background:#1e293b; border:1px solid #475569; color:white; border-radius:6px; font-size:1rem;">
                    </div>
                    <button id="btn-start-game-custom" class="btn-primary" style="width:100%; padding:12px; font-size:1rem; border-radius:8px; border:none; cursor:pointer; margin-bottom:10px;">🎮 Empezar Aventura</button>
                    <p style="color:#fbbf24; font-size:0.85rem; font-style:italic; text-align:center; margin:0;">
                        💰 Compra, vende, alquila... ¡Construye tu futuro!
                    </p>
                `;
